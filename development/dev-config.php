<?php
  ...
  define('DB_HOST', 'doma-db');
  define('DB_USERNAME', 'doma-developer');
  define('DB_PASSWORD', 'orienteering');
  // The name of the database where the map information is stored. The database must exist prior to creation of the site.
  define('DB_DATABASE_NAME', 'domadb');
  ...
  define('DB_COLLATION', 'utf8_danish_ci');
